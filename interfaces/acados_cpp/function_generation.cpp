                                                 ...
                                                 string output_folder, const bool use_MX)
{
    ...
    if (use_MX == false)
    {
        ...
        fun = casadi::Function(model.name() + "_impl_ode_fun_jac_x_xdot_z", {x, xdot, u, z},
                               {rhs, jac_x, jac_xdot, jac_z});
    }
    else  // MX
    {
        casadi::MX x = model.mx_in("x");
...
casadi_module generate_impl_ode_jac_x_xdot_u_z(const casadi::Function& model, string output_folder,
                                               const bool use_MX)
{
    casadi::Function fun;
    if (use_MX == false)
    {
        ...
        fun = casadi::Function(model.name() + "_impl_ode_jac_x_xdot_u_z", {x, xdot, u, z},
...
casadi_module generate_impl_ode_hess(const casadi::Function& model, string output_folder,
                                     const bool use_MX)
{
    casadi::Function fun;
    if (use_MX == false)
                                                 ...
                                                 string output_folder, const bool use_MX)
{
    ...
    if (use_MX == false)
    {
        ...
        fun = casadi::Function(model.name() + "_impl_ode_fun_jac_x_xdot_u", {x, xdot, u, z},
                               {rhs, jac_x, jac_xdot, jac_u});
    }
    else  // MX
    {
        casadi::MX x = model.mx_in("x");
                                     ...
                                     const bool use_MX)
{
    ...
    if (use_MX == false)  // SX
    {
        ...
        fun = casadi::Function(model.name() + "_expl_ode_hess", {x, Sx, Sp, lambdaX, u},
                               {adj, hess2});
    }
    else  // MX
    {
